<x-layout>
    ...
    <div class="bg-green-50 h-full">
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 pt-16">
            <div class="flex flex-col">
                <div
                    ...
                    <div class="flex justify-between font-bold">
                        ...
                        <a id="refreshButton">
                            <img src="{{ asset('images/refresh.png') }}" alt="Refresh" class="h-6 w-auto">
                        </a>
                    </div>
                    <div class="flex-row justify-items-center">
                        <h1 class="text-6xl lg:text-8xl font-semibold py-4">{{ $air->air_quality }}</h1>
                        <h3 class="mt-4">Terakhir diperbarui: {{ $air->created_at->format('d M Y, H:i:s') }}</h3>
                    </div>
                </div>
                <div class="flex mx-4 mb-4 rounded-b-md justify-between p-4 shadow-md h-28 items-center bg-white">
                    <div class="flex-1">
            ...
            <div>
                <div class="rounded-md shadow-md p-4 mx-4 text-green-900 mb-4 mt-4 bg-white">
                ...
                <div class="rounded-md shadow-md p-4 mx-4 mb-4 bg-white">
        ...
        <div class=" mx-4 @if ($air->air_quality !== 'Hazardous') mb-20 md:mb-4 @endif rounded-b-md p-4 shadow-md space-y-2 bg-white">
        ...
        @if ($air->air_quality == 'Hazardous')
            <div
                class="fixed bottom-0 left-0 w-full z-50 bg-red-600 text-white px-4 py-3 flex items-center space-x-3 shadow-md pb-18 md:pb-3">
                <!-- Ikon Warning -->
